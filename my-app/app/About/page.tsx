...
export default function About() {
    return (
        <>
            <Header />
            <div className=" w3-container p-4 pt-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 gap-4  max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col items-center text-center m-10">
                    <img className="w-50 h-50 mb-6 rounded-full" src="/AVTeam/vaibhavchougule.jpg" alt="Vaibhav Chougule" />
                    <h5 className="mb-0.5 text-xl font-semibold tracking-tight text-heading">Vaibhav Chougule</h5>
                 ...
                 <div className="flex flex-col items-center text-center m-10">
                    <img className="w-50 h-50 mb-6 rounded-full" src="/AVTeam/ankush.jpg" alt="Ankush" />
                    <h5 className="mb-0.5 text-xl font-semibold tracking-tight text-heading">Ankush</h5>
                    <span className="text-sm text-body">Visual Designer</span>
                    <div className="flex mt-4 md:mt-6 gap-4">
